levels = {
    {
        ...
        queue_level_start_dialog=function()
            dialog:queue("so you think you got what it takes to be a safe cracker, eh? well we'll see about that...my names rob, and as it happens our last guy just got busted, you wouldn't konw anything about that, would you?")
